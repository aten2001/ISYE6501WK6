...
The data is imported using `read.csv()` without headers. Besides the obvious (numerical ID and class) all variables are assumed to be categorical since  they all exhibit the curious phenomenon of having only integer values between 1 and 10. Column 7 contains 16 missing data points which amounts to about 2.3% of the total measured. 
